...
public class PatientControllerTest {
    ...
    public void test() throws Exception {
        ...
        Patient patient = new Patient(1L,"toto","titi",new Date(),"male","0606060606","29, rue moulin", note,patientStatusDto);

        Patient patient2 = new Patient(2L,"olivier","giroud",new Date(),"male","0606060606","29, rue moulin", note,patientStatusDto);
